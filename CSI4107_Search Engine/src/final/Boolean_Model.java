...
public class Boolean_Model {
	...
	Boolean_Model(boolean stopword, boolean normalization, boolean stemming) {
		...
		wordsetList = db.getDictionary(); //in dictionary
	}
	
	//REUTERS
	Boolean_Model(DictionaryBuilder db) {
		this.db = db;
	...
	public static void main(String[] args) throws IOException {
		/*Boolean_Model bmodel = new Boolean_Model(true,true,true,'r'); 
		//ArrayList<String> t = bmodel.postfixEval(bmodel.infixToPostfix("sharehold OR secur"));
		ArrayList<String> t = bmodel.singleWordQuery("shareholder");
